        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    @endif
                    <form action="/admin/edit_products/editproductform" method="POST" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="update_id" value="{{$editdetails['id']}}">
                        <div class="row">
                            <div class="col-md-5 form-group">
                                <label for="">Product Name <sup style="color: red;">*</sup></label>
                                <input type="text" class="form-control" name="p_name" id="p_name"
                                    placeholder="Product Name" value="{{$editdetails['name']}}">
                            </div>
                            <div class="col-md-3 form-group">
                                <label for="">Product Price <sup style="color: red;">*</sup></label>
                                <input type="text" class="form-control" name="p_price" id="p_price"
                                    placeholder="Product Price" value="{{$editdetails['price']}}">
                            </div>
